...
1.  Download the example plant for the TurtleBot3 World link:openTCS-NeNa-Documentation/src/docs/turtlebot3_world_example_plant/example_model_scaled.xml[(link)].
