...
//
//public class NodeMessageRunningTesterApplication implements NodeRunningStatusListener, NodeMessageListener {
//    NodeManager nodeManager;
//    int cnt = 0;
//    public static void main(String[] args) {
//        new NodeMessageRunningTesterApplication().run();
//    }
//
//    private void run() {
...
//
//    @Override
//    public void onNodeStatusChange(NodeRunningStatus nodeRunningStatus) {
//        if (nodeRunningStatus == NodeRunningStatus.ACTIVE){
